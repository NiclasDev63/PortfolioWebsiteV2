...
const experience = [
  {
    ...
    jobtitle: "Student",
    description:
      "I am currently pursuing my Bachelor's degree in Computer Science at the technical university of Darmstadt.",
    date: "October 2022",
  },
  {
    ...
    description:
      "I spent two months as a Trainee / Cloud Engineer developing REST APIs and CI/CD pipelines in Python and deploying them to the cloud (AWS). These projects involved technology such as: Python, Flask, Docker, Kubernetes, various AWS Cloud Services, Terraform, Prometheus, Grafana and more.",
